 ...
 * They do not own or mutate any shared state maps; that responsibility belongs to `index.ts`.
 */
 ...
 * @param anchor - The created anchor `<span>` (used as a secondary font-style reference).
